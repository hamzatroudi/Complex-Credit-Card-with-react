...
import {addSportif} from '../service'
...
class Addsportif extends Component {
    constructor(props) {
        super(props);
        this.state={
            username:"",
    ...
    insert_sportifs = () => {
        ...
        sportif.append('itemJson', JSON.stringify(
