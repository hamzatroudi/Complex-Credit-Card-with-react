...
import {MainNav, ComponentsNav,ComponentsGestion, FormsNav, WidgetsNav, ChartsNav, Sportifs, ABout} from './NavItems';
...
class Nav extends Component {
    ...
    render() {
        ...
        <MetisMenu content={MainNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
                <h5 className="app-sidebar__heading">Gestion</h5>
                <MetisMenu content={ComponentsGestion} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
                <h5 className="app-sidebar__heading">A propos</h5>
               ...
               {/* <h5 className="app-sidebar__heading">UI Components</h5>
                ...
                <h5 className="app-sidebar__heading">Gestion des sportifs</h5>
                <MetisMenu content={Sportifs} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
        */} </Fragment>
        );
    }
